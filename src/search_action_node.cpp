...
private:
  void do_work()
  {
    ...
    if ((old_fd_1!=fd_1)||(old_fd_2!=fd_2)) {
      ...
      //   std::bind(&SearchAction::goal_response_callback, this, _1);
  ...
  // {
  //   RCLCPP_INFO(this->get_logger(), "Performing Search Action");
  // }
...
int main(int argc, char ** argv)
{
  ...
  node->set_parameter(rclcpp::Parameter("action_name", "search_pipeline"));
